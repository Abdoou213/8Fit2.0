...
export async function updateUserStats(user:User, finalizedSession:WorkoutSession) {
  ...
  const totalWeightLiftedAllTime = userStats[4] + calculateTotalWeightLifted(finalizedSession);
